	...
	<div class="row pt-4">
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 pl-2 pr-2">
			...
			<div class="loginbox pl-4 pr-4">
				...
				<div class="form-group">
					<input type="text" name="location" id="location" tabindex="2" class="form-control hidden" placeholder="Current Location" value="Colombo, Sri Lanka">
				</div>
				<div class="form-group text-left">
					...
					<button type="button" id="back" tabindex="4" class="btn btn-secondary hidden">Back</button>
				</div>
			</form>
			</div>
		</div>
...
<script>
	...
	var heroReference=firebase.database().ref().child("admin");
