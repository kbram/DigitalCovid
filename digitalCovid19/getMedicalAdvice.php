...
<div class="container-fluid mt-5 pt-5 pb-5">
	<div class="row pt-4">
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 pl-1 pr-1">
			<h2 class="fnt-green">Available Doctors</h2><br>
...
<script>
	...
	userReference.on("value",function(snapshot){
		...
		var min=8;
		var c=8;
		heroHTMLItems+="<p align='left'>Available Doctors for proximity range</p>";
		snapshot.forEach(function(childsnapshot){
			var person=childsnapshot.val();
		...
		if(x==false){
			heroHTMLItems+="<p align='left'>In your region don't have doctors, We connect our Head office doctors</p>";
