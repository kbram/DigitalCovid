...
<div class="container-fluid mt-5 pt-5 pb-5">
	<div class="row pt-4">
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 pl-1 pr-1">
			<h2 class="fnt-green">தொடர்பு கொள்ளக்கூடிய மருத்துவர்கள்.</h2><br>
...
<script>
	...
	userReference.on("value",function(snapshot){
		...
		var min=8;
		var c=8;
		heroHTMLItems+="<p align='left'>அருகாமையில் உள்ள வைத்தியர்களின் விபரம் </p>";
		snapshot.forEach(function(childsnapshot){
			var person=childsnapshot.val();
		...
		if(x==false){
			heroHTMLItems+="<p align='left'>உங்கள் பிராந்தியத்தில் மருத்துவர்கள் இல்லை, நாங்கள் எங்கள் தலைமை அலுவலக மருத்துவர்களை இணைக்கிறோம்</p>";
