...
<html lang="en-US">
<head>
  <title>எனது நிகழ்ச்சிகள் - எண்ணிம கோவிட் -19</title>
...
<div class="container-fluid mt-5 pt-5 pb-5">
	<div class="row pt-4">
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 fnt-gray pl-2 pr-2">
			<h2 class="fnt-green pl-1">நிகழ்ச்சியில் பங்குபற்றல்</h2>
			<div class="loginbox pl-4 pr-4 pt-2">
				<form >
				<div class="form-group">
					<input required type="text" onchange="fillLocation(this.value)" name="eventName" id="eventName" class="form-control eventName" placeholder="நிகழ்வின் பெயர்">
				</div>
				<div class="form-group">
					<input required type="text" name="location" id="location" class="form-control" placeholder="இடம்">
				</div>
				<div class="form-group">
					<label class="pl-2">திகதி</label>
					<input required type="date" id="eDate" name="eDate" max="3000-12-31" min="1000-01-01" class="form-control">
				</div>
				<div class="form-group text-left">
					<button type="button" name="save-submit" id="btn_saveform" class="btn btn-green" value="save-submit">நிகழ்ச்சியை சேர்க்கவும்</button>
				</div>
			</form>
			</div><br>
			<h2 class="fnt-green pl-1">எனது நிகழ்ச்சிகள்</h2><br>
...
<script type="text/javascript">
	...
	function addEvent(e){
		if(e.name==""){
			window.alert("நிகழ்சிகள் புதுப்பிக்கப்படவில்லை மீண்டும் முயற்சிக்கவும்")
		}else{
			...
			window.alert("நிகழ்சிகள் புதுப்பிகப்படது")
		}
	}
	var arr=Array();
    var num="0"
	...
	function(){
		arr.forEach(function(item){
			...
			EventsReference.on("value",function(snapshot){
				...
				if(mess==0){
					heroHTMLItems+="<p align='center'>நிகழ்சிகள் இல்லை, பதிவு செய்யவும்</p><br><br>";
				}
			});
		});
